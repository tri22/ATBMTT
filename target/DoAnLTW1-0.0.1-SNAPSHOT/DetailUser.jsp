...
<body>
	<form action="EditUserController" method="post" class="container border ">
		...
		<div class="row g-3 justify-content-center align-items-center p-1">
            <div class="col-auto">
                <label class="col-form-label width-100">User ID</label>
            </div>
            <div class="col-auto">
                <input type="text" class="form-control" name="userId" value="${user.userId}" readonly aria-describedby="passwordHelpInline">
            </div>
        </div>
        
        <div class="row g-3 justify-content-center align-items-center p-1">
            <div class="col-auto">
                <label class="col-form-label width-100">Username</label>
            </div>
            <div class="col-auto">
                <input type="text" class="form-control" name="username" value="${account.username}" readonly aria-describedby="passwordHelpInline">
            </div>
        </div>
        
        <div class="row g-3 justify-content-center align-items-center p-1">
            <div class="col-auto">
                <label class="col-form-label width-100">Password</label>
            </div>
            <div class="col-auto">
                <input type="text" class="form-control" name="password" value="${account.password}" readonly aria-describedby="passwordHelpInline">
            </div>
        </div>
        ...
        <div class="row g-3 justify-content-center align-items-center p-1">
            <div class="col-auto">
                <input type="submit" value="Edit User" class="bg-lightgreen no-border rounded p-1 px-2 ">
            </div>
            <div class="col-auto">
                <input type="button" value="Home" class="bg-lightgreen no-border rounded p-1 px-2 ">
            </div>
        </div>
    </form>
</body>
