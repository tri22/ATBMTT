                ...
                <div class="col-10 flex-column  rounded mt-3 mb-2 ">
                    <nav aria-label="breadcrumb pb-5" style="background-color: #edf2f9; margin: 0 -12px;">
                        <ol class="breadcrumb mb-0" style="padding: 25px;">
                            <li class="breadcrumb-item active bold-text font-25" aria-current="page" >
                                ...
                                <a class="text-decoration-none" href="addpd.jsp">/ Employee list</a>
                            </li>
                        </ol>
                    </nav>
                    <table class="row  px-3 rounded ">
                        <tr class="bg-white border-bottom">
                                ...
                                <td class="col-3 mt-4" style="width: 250px;">
                                    <p class="bold-text text-center" style="width: 150px;margin:0 15px 0 30px;">Maneger</p>
                                 </td>
                                <td class="col-3 my-5 ml-5 d-flex justify-content-center" style="width: 300px;">
                                    <a id="editButton" class="col-4 m-2 editBtn text-center text-decoration-none bg-color-blue text-white py-2 rounded bold-text" href="" >Edit order</a>
                                    <a id="deleteButton" class="col-4 m-2 deleteBtn text-center text-decoration-none bg-color-blue text-white py-2 rounded bold-text" href="#" type="button" >Delete order</a>
                                </td>
                        </tr>
                        <tr class="bg-white border-bottom">
                            <td class="col-3 text-center" >
