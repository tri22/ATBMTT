...
<body>
	<form action="EditController" method="post" class="container border" enctype="multipart/form-data">
        ...
        <div class="row g-3 justify-content-center align-items-center p-1">
            ...
            <div class="col-auto">
                <input type="file" class="form-control" name="imageUrl" value="${product.imageUrl}" aria-describedby="passwordHelpInline">
            </div>
        </div>
        ...
        <div class="row g-3 justify-content-center align-items-center p-1">
            ...
            <div class="col-auto">
            	<a href="">
	                <input type="button" value="Cancel" class="bg-lightgreen no-border rounded p-1 px-2 ">
            	</a>
            </div>
        </div>
    </form>
