...
<head>
    ...
    <link rel="stylesheet" href="./adminhub/css/style.css">
                ...
                <div class="card p-4">
                    ...
                    <div class="text-center mb-4">
                        <div class="avatar mx-auto mb-3">
                            <img src="${user.avatar != null ? user.avatar : 'https://via.placeholder.com/150'}" alt="User Avatar">
                        </div>
                    ...
                    <form action="HomeController" method="post">
                        ...
                        <div class="d-flex justify-content-between mt-4">
                            <button type="submit" class="btn btn-custom px-4">Home</button>
                            <a href="EditUserController?accId=${user.getAccount().accId}" class="btn btn-outline-success px-4">
