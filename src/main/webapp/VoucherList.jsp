                    ...
                    <nav aria-label="breadcrumb pb-5" style="background-color: #edf2f9; margin: 0 -12px;">
                        <ol class="breadcrumb mb-0" style="padding: 25px;">
                            <li class="breadcrumb-item active bold-text font-25" aria-current="page" >
                                ...
                                <a class="text-decoration-none" href="addpd.jsp">/ Voucher list</a>
                            </li>
                        </ol>
                    </nav>
                    <table class="row  px-3 rounded ">
                            <tr class="bg-white border-bottom">
                                <td class="col-6 px-3 align-self-start" > 
                                ...
                                <td class="col-6 d-flex flex-column" style="width: 150px;margin: 0 150px;">
                                    <h3 class="align-self-center mt-2" style="color: rgba(245, 128, 62,1);">SL: 100</h3>
                                    <div class=" d-flex flex-column justify-content-between mb-2">
                                        <a class="m-2 align-self-center text-decoration-none bg-color-blue text-white p-2 rounded bold-text" href="" >Edit voucher</a>
                                        <a id="deleteButton" class="deleteBtn m-2 align-self-center text-decoration-none bg-color-blue text-white p-2 rounded bold-text" href="#" type="button" >Delete voucher</a>
                                    </div>
                                </td>
                            </tr>
                            <tr class="bg-white border-bottom">
