                ...
                <nav aria-label="breadcrumb pb-5" style="background-color: #edf2f9; margin: 0 -12px;">
                    <ol class="breadcrumb mb-0" style="padding: 25px;">
                        <li class="breadcrumb-item active bold-text font-25" aria-current="page" >
                            ...
                            <a class="text-decoration-none" href="addVoucher.jsp">/ Add Voucher</a>
                        </li>
                    </ol>
                </nav>
                <div class="bg-white rounded">
                    <div class="px-5 pt-4">
                        <label for="inputPassword5" class="form-label">Voucher name</label>
                        <input type="text" id="" class="form-control">
                    </div>
                    <div class="px-5 pt-4" >
                        <label for="inputPassword5" class="form-label">Voucher ID</label>
                        <input type="text" id="" class="form-control">
                    </div>
                    <div class="px-5 pt-4">
                        <label for="inputPassword5" class="form-label">Voucher description</label>
                        <input type="text" id="" class="form-control">
                    </div>
                    <div class="row px-5 pt-4">
                        <div class="col-6">
                            <label for="inputPassword5" class="form-label">Voucher code</label>
                            <input type="text" id="" class="form-control">
                        </div>
                        <div class="col-6">
